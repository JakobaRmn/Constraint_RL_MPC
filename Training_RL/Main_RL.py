...
future_steps_tracing = [0, 0, 0]  # number of steps the tracing trajectory is used from the future -> 0 = Nonw
buffersize = 10000
...
future_steps_dist = [0, 0, 0]  # number of steps the disturbance is used from the future -> 0 = None
...
for number in episodesTrain:
    ...
    nb_disturbance = nb_actions * future_steps_dist[count]  # dim d x future steps
    ...
    agent = DDPG_Agent(actor=actor, critic=critic, critic_action_input=critic.InputActions,
                       constraint_T_1=constraint_temp_up, constraint_E_1=constraint_energy_up,
                       constraint_T_2=constraint_temp_low, constraint_E_2=constraint_energy_low,
                       memory=replayBuffer, random_process=random_process, constraint=constraints,

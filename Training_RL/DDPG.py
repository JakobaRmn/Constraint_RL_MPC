...
class DDPG_Agent:
    ...
    """
    def __init__(self, actor, critic, critic_action_input, memory, constraint_T_1=None, constraint_E_1=None,
                 constraint_T_2=None, constraint_E_2=None, random_process=None, batch_size=64, gamma=.99,
        ...
        # constraints
        self.constraint_T_1 = constraint_T_1
        self.constraint_T_2 = constraint_T_2

        self.constraint_E_1 = constraint_E_1
        self.constraint_E_2 = constraint_E_2
    ...
    def constrain_action(self, action, env):
        ...
        state_new[0, 0] = (state[0, 0] - 20) / 5
        state_new[1, 0] = state[1, 0] / 200000
